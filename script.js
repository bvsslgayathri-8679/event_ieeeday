...
const day3 = [
  {
    name: "Explore your passion (ECE/EEE) workshop",
    startTime: "16:30",
    endTime: "17:30",
    link: "http://ieeesbgvpce.org/",
    speaker: "Mr.abc",
...
const day5 = [
  {
    name: "Explore your passion (CSE/IT) workshop",
    startTime: "16:30",
    endTime: "17:30",
    link: "http://ieeesbgvpce.org/",
    speaker: "Mr.abc",
...
let modalContent = (ev) => {
  ...
  para.innerHTML = `Time: ${ev.startTime} - ${ev.endTime} (IST)`;
  let fee = document.createElement('h4');
  fee.innerHTML = "Fee : Rs.250(ieee member)\ Rs.350(non-ieee member)";
  let speak = document.createElement('h4');
  speak.innerHTML = `<br>Speaker: ${ev.speaker}`;
  let lnk = document.createElement('a');
  lnk.innerHTML = "Register" + "<br>";
  let suggestion = document.createElement('small');
  suggestion.innerHTML = "<br>click on outside to close modal";
  lnk.href = `${ev.link}`;
